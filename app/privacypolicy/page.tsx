...
const page = (props: Props) => {
    return (
        <div className='text-sm p-10'>
            ...
            when you visit the Platform, we use cookies to automatically collect, store and use technical information about your system and interaction with our Platform and the services used after accessing the Platform;
            If you choose to access services offered by any of our affiliates we will share your data with the affiliate in accordance with this policy. When you access the webpage/link or services of our affiliates through the Platform, you will also be governed by the terms and privacy policy of such affiliates. You are advised to read the terms and privacy policy of the affiliates to understand the manner in which the affiliates handle and process your personal data, including sharing your data with IEIL.
            ...
            Sending you information about our products and services (including those of our affiliates) for marketing purposes and promotions;
            ...
            rewindjobs’s use and transfer to any other app of information received from Google APIs will adhere to Google API Services User Data Policy, including the Limited Use requirements.
            ...
            We partner with affiliates to provide additional services to you, for purposes related to the Platform, such as career enhancement, skill development, interview preparation etc. For instance, we offer ‘Code 360’ – a service that offers coding courses to help you with career and skill enhancement. Code 360 is operated by [Sunrise Mentors Private Limited] under the brand ‘Coding Ninjas.’ If you access Code 360 on the rewindjobs.com platform, your personal data will also be governed by the privacy policy of Coding Ninjas.

            You may review the privacy policy of Coding Ninjas services here

            To the extent that your data is retained by IEIL, this Policy continues to apply, however, IEIL makes no representations or warranties regarding how your information is stored or used on third-party servers. We recommend that you review the applicable privacy statements and policies of each third-party site linked from the Platform to determine their use of your personal information.
            ...
            IEIL provides you the ability to keep your Personal Information accurate and up-to-date. If at any time you would like to a) rectify, update or correct your Personal Information; b) obtain confirmation on whether or not your Personal Information is processed by it; c) access your Personal Information or exercise your right to data portability; or d) exercise your right to restrict the continuing disclosure of your Personal Information to any third party by IEIL in certain circumstances, you are requested to contact us using the contact details mentions in paragraph 14 below. We will require you to provide a valid proof of your identity, in order to ensure that your rights are respected.
            ...
            At any time, if you wish to delete your account on rewindjobs.com, you may do so by using the settings available in your account.
            ...
            Analytics Cookies	These cookies track information about visits to the rewindjobs.com and partner (recruiter websites) websites so that we can make improvements and report our performance. For example: analyse visitor and user behaviour so as to provide more relevant content or suggest certain activities. They collect information about how visitors use the Websites, which site the user came from, the number of each user’s visits and how long a user stays on the Websites. We might also use analytics cookies to test new ads, pages, or features to see how users react to them.
            Functionality or Preference Cookies	During your visit to the Websites, cookies are used to remember information you have entered or choices you make (such as your username, language or your region) on the Websites. They also store your preferences when personalizing the Websites to optimize your use of rewindjobs.com. These preferences are remembered, through the use of the persistent cookies, and the next time you visit the Websites you will not have to set them again.
            Targeting or Advertising Cookies	These Cookies are placed by third party advertising platforms or networks or rewindjobs.com in order to, deliver ads and track ad performance, enable advertising networks to deliver ads that may be relevant to you based upon your activities (this is sometimes called "behavioural" "tracking" or "targeted" advertising) on the Websites. They may subsequently use information about your visit to target you with advertising that you may be interested in, on rewindjobs.com websites or other websites. For example, these cookies remember which browsers have visited the websites.


            d. When does rewindjobs.com place cookies?
            ...
            rewindjobs.com occasionally advertises on third party websites. As part of our effort to track the success of our advertising campaigns, we may at times use a visitor identification technology such as "web beacons," or "action tags," which count visitors who have come to our site after being exposed to a rewindjobs.com banner ad on a third party site. Our partners may also use web beacons to collect data in the aggregate as provided by your browser while you are on our site or another site where rewindjobs.com is third party.
