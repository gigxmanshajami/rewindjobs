        ...
        <div className="bg-[#f6f6f6] -mt-40">
            <div className="mx-auto max-w-2xl pt-20 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        <div className="flex gap-2 ">
                            ...
                            <h5 className="text-base font-normal text-black  ">925 Filbert Street Pennsylvania 18072</h5>
                        </div>
                        <div className="flex gap-2 mt-10 ">
                            <Image src={'/assets/footer/telephone.svg'} alt="telephone-icon" width={24} height={24} />
                            <h5 className="text-base font-normal  text-black ">+ 45 34 11 44 11</h5>
                        </div>
                        <div className="flex gap-2 mt-10 ">
                            <Image src={'/assets/footer/email.svg'} alt="email-icon" width={24} height={24} />
                            <h5 className="text-base font-normal  text-black ">info@gmail.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-black text-sm text-center lg:text-start font-normal'>@2024 All Rights Reserved By RewindJobs <Link href="https://manshajami.xyz/" target="_blank">|| Developed By Mansha Jami </Link></h4>
